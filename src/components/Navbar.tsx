...
rounded-lg transition-all duration-300 flex items-center gap-1 ${
              ...
              <button
                ...
                className={`ml-4 bg-gradient-to-r from-primary to-primary-dark text-primary-foreground rounded-full font-semibold overflow-hidden shadow-[0_4px_15px_hsl(var(--primary)/0.3)] hover:shadow-[0_6px_25px_hsl(var(--primary)/0.45)] transition-all duration-300 hover:-translate-y-0.5 ${
              ...
              {navLinks.map((link, index) => (
                ...
                <div className="pt-4 mt-2 border-t border-slate-100 flex flex-col">
                  <motion.button
                    ...
                    className="bg-gradient-to-r from-primary to-primary-dark text-primary-foreground px-5 py-3 rounded-xl text-sm font-semibold mt-2 text-center w-full shadow-[0_4px_15px_hsl(var(--primary)/0.3)] transition-all duration-300 hover:shadow-[0_6px_25px_hsl(var(--primary)/0.45)] hover:-translate-y-0.5"
                  >
                    Book Demo
                  </motion.button>
              </div>
