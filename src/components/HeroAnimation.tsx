...
`}</style>
  ...
  <div className="float-bar-chart">
    <div className="bar-chart-3d">
      <div className="bar-col" style={{height: '45px', background: 'linear-gradient(to top,#5c6bc0,#7986cb)'}}></div>
      <div className="bar-col" style={{height: '65px', background: 'linear-gradient(to top,#42a5f5,#64b5f6)'}}></div>
      <div className="bar-col" style={{height: '50px', background: 'linear-gradient(to top,#66bb6a,#81c784)'}}></div>
      <div className="bar-col" style={{height: '80px', background: 'linear-gradient(to top,#ffa726,#ffb74d)'}}></div>
      <div className="bar-col" style={{height: '55px', background: 'linear-gradient(to top,#5c6bc0,#7986cb)'}}></div>
    </div>
  </div>
