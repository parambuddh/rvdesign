        ...
        <section className="px-4 md:px-8">
          <div className="max-w-4xl mx-auto">
            <Accordion type="single" collapsible className="space-y-4">
              ...
              {/* 1. Get Started (NEW) */}
              <AccordionItem value="get-started" className="premium-card bg-white border-sky-100 shadow-sm overflow-hidden">
                ...
                <AccordionContent className="px-6 pb-6 text-text-body leading-relaxed space-y-4">
              ...
              {/* 2. Key Features */}
              <AccordionItem value="key-features" className="premium-card bg-white border-sky-100 shadow-sm overflow-hidden">
                <AccordionTrigger className="hover:no-underline px-6 py-5">
                  <div className="flex items-center gap-3">
                ...
                <AccordionContent className="px-6 pb-6 text-text-body leading-relaxed">
              ...
              <AccordionItem value="why-rvc" className="premium-card bg-white border-sky-100 shadow-sm overflow-hidden">
                <AccordionTrigger className="hover:no-underline px-6 py-5">
                  <div className="flex items-center gap-3">
                ...
                <AccordionContent className="px-6 pb-6 text-text-body leading-relaxed space-y-6">
              ...
              <AccordionItem value="component-setup" className="premium-card bg-white border-sky-100 shadow-sm overflow-hidden">
                <AccordionTrigger className="hover:no-underline px-6 py-5">
                  <div className="flex items-center gap-3">
              ...
              <AccordionItem value="properties" className="premium-card bg-white border-sky-100 shadow-sm overflow-hidden">
                <AccordionTrigger className="hover:no-underline px-6 py-5">
                  <div className="flex items-center gap-3">
                    <Settings className="h-5 w-5 text-primary" />
              ...
              <AccordionItem value="r-views" className="premium-card bg-white border-sky-100 shadow-sm overflow-hidden">
                <AccordionTrigger className="hover:no-underline px-6 py-5">
                  <div className="flex items-center gap-3">
                    <Layout className="h-5 w-5 text-primary" />
              ...
              {/* 7. Sample Data (NEW) */}
              <AccordionItem value="sample-data" className="premium-card bg-white border-sky-100 shadow-sm overflow-hidden">
                <AccordionTrigger className="hover:no-underline px-6 py-5">
                  <div className="flex items-center gap-3">
                    <Box className="h-5 w-5 text-primary" />
              ...
              <AccordionItem value="toolbar" className="premium-card bg-white border-sky-100 shadow-sm overflow-hidden">
                <AccordionTrigger className="hover:no-underline px-6 py-5">
                  <div className="flex items-center gap-3">
                    <Laptop className="h-5 w-5 text-primary" />
              ...
              <AccordionItem value="configuration" className="premium-card bg-white border-sky-100 shadow-sm overflow-hidden">
                <AccordionTrigger className="hover:no-underline px-6 py-5">
                  <div className="flex items-center gap-3">
                    <Settings className="h-5 w-5 text-primary" />
              ...
              <AccordionItem value="create-records" className="premium-card bg-white border-sky-100 shadow-sm overflow-hidden">
                <AccordionTrigger className="hover:no-underline px-6 py-5">
                  <div className="flex items-center gap-3">
              ...
              <AccordionItem value="use-cases" className="premium-card bg-white border-sky-100 shadow-sm overflow-hidden">
                <AccordionTrigger className="hover:no-underline px-6 py-5">
                  <div className="flex items-center gap-3">
                    <Layers className="h-5 w-5 text-primary" />
                ...
                <AccordionContent className="px-6 pb-6 text-text-body leading-relaxed space-y-8">
              ...
              <AccordionItem value="styling" className="premium-card bg-white border-sky-100 shadow-sm overflow-hidden">
                <AccordionTrigger className="hover:no-underline px-6 py-5">
                  <div className="flex items-center gap-3">
              ...
              {/* 13. FAQ & Support */}
              <AccordionItem value="faq" className="premium-card bg-white border-sky-100 shadow-sm overflow-hidden">
                <AccordionTrigger className="hover:no-underline px-6 py-5">
                  <div className="flex items-center gap-3">
