      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            className="fixed bottom-4 md:bottom-6 right-4 md:right-6 z-40 w-12 h-12 rounded-full bg-primary text-white shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-300"
